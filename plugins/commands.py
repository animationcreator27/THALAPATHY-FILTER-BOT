                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                ...
                                InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url="https://t.me/cinewood_1")
                            ],
                            [
                        ...
                        [
                         [
                          ...
                          InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/cinewood_1")
                            ...
                            InlineKeyboardButton('🚀 Fast Download / Watch Online🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @cinewood_1
                            ]
                        ]
                    )
                )
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\ncommand is still incomplete !\n\nFormat: <code>/If there is any problem please contact - @cinewood_1</code></b>")
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        return await message.reply("<b>command is still incomplete\n\nCommand Usage: /set_tutorial 🖇️</b>")
